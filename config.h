...
static const char *fonts[]          = { "SourceHanSansCN-Heavy:size=12" };
static const char dmenufont[]       = "SourceHanSansCN-Heavy:size=12";
static const char col_azure[]       = "#F0FFFF";
static const char col_silver[]       = "#c0c0c0";
static const char col_crimson[]       = "#DC143C";
static const char col_springgreen[]       = "#ffffe0";
static const char col_celeste[]        = "#2a52be";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeSel] = { col_crimson, col_azure, col_silver },
	[SchemeNorm]  = { col_springgreen, col_celeste,  col_celeste  },
};
...
#define SHCMD(cmd) { .v = (const char*[]){ "/bin/sh", "-c","/playground/ZSH/sh", cmd, NULL } }
